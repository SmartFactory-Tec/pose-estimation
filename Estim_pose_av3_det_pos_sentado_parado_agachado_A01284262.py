# -*- coding: utf-8 -*-
"""
Created on Fri Dec  1 15:47:47 2023
...
with mp_pose.Pose(min_detection_confidence=0.6, min_tracking_confidence=0.4) as pose:
    while capcam.isOpened():
        ...
        try:
            ...
            # condiciones de ángulo para determinar una posición
            if lft_th_knee and rgt_th_knee <= 90:
                print('sentado')
            elif lft_th_knee and rgt_th_knee > 120:
                print('Parado')
            else:
              if lft_th_hip or rgt_th_hip < 60:
                print('Agachado')
        except:
